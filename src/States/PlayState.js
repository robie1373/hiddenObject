...
PlayState.create = function () {
    ...
    //Add hint button
    this.hintBtn = new Kiwi.GameObjects.Sprite(PlayState, PlayState.textures.UI_btn, 648, 0);
    this.addChild(this.hintBtn);

    //Add hint icon button
    this.hintIcon = new Kiwi.GameObjects.Sprite(PlayState, PlayState.textures.hint_btn, 648, 0);
...
*/
    ...
    for (i = 0; i < SharedData.gameInstanceData.numObjects; i++) {
      this.addHiddenObject(SharedData.gameInstanceData.hiddenObjectImages[i], Math.random() * 600, Math.random() * 700);

//      this.addHiddenObject(hiddenOjbectImages[getRandomInt(hiddenOjbectImages.length)], Math.random() * 600, Math.random() * 700);
    }
}
...
PlayState.addHiddenObject = function (objName, objX, objY) {
    ...
    //this['hiddenObject' + objName] = new Kiwi.GameObjects.Sprite(PlayState, PlayState.textures[objName], objX, objY);
